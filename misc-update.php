 ...
 * @ author J.R.Marlatt
 * version 1.0 January 4, 2020 
 */

get_header(); ?>

<div style="width:100%;">
<p style="font-family:'Georgia';font-variant:small-caps; font-size:80%; font-weight:700; margin: 0 0 0 0;">Updated: 01/04/2020</p>
<h1 class="t1USDCB";>Update an Existing MISC Data Record</h1>
<hr>
...
<hr>
<br>
<!--<form action="http://www.us-covered-bonds.com/MISC_Update /" name='updateMISC' method="POST">-->
    <form name='updateMISC' method="POST">
WHERE<br>
Record Number:
	<input type="text" name="wifield1" placeholder="Insert Value" style="position:absolute; left:300px;"><br><br>
<br />
	UPDATE<br>
Date:	<input type="text" name="uifield1" style="position:absolute; left:300px;" placeholder="Insert Date"><br><br>
Issuer:	<input type="text" name="uifield2" style="position:absolute; left:300px;" placeholder="Insert Issuer"><br><br>
Asset:	<input type="text" name="uifield3" style="position:absolute; left:300px;" placeholder="Insert Type/Asset"><br><br>
Series:	<input type="text" name="uifield4" style="position:absolute; left:300px;" placeholder="Insert Series"><br><br>
Amount:	<input type="text" name="uifield5" style="position:absolute; left:300px;" placeholder="Insert Amount"><br><br>
Maturity:	<input type="text" name="uifield6" style="position:absolute; left:300px;" placeholder="Insert Maturity"><br><br>
Ratings:	<input type="text" name="uifield7" style="position:absolute; left:300px;" placeholder="Insert Ratings"><br><br>
Type:	<input type="text" name="uifield8" style="position:absolute; left:300px;" placeholder="Insert Type"><br><br>
Underwriters:	<input type="text" name="uifield9" style="position:absolute; left:300px;" placeholder="Insert Underwriters"><br><br>
Description:	<input type="text" name="uifield10" style="position:absolute; left:300px;" placeholder="Insert Description"><br><br>
Link:	<input type="text" name="uifield11" style="position:absolute; left:300px;" placeholder="Insert Link"><br><br><br>

	<input name='updateMISC' type="submit" value="Submit MISC Update">
</form>
